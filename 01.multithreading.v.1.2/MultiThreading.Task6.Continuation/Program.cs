...
namespace MultiThreading.Task6.Continuation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ExecuteRegardlessOfResult();
            ExecuteWhenTaskWithoutSuccess();
            ExecuteTaskFailAndThreadShouldReuse();
            ExecuteWhenTaskWouldBeCancelling();

            Console.ReadLine();
        }

        private static void ExecuteRegardlessOfResult()
        {
        ...
        private static void ExecuteWhenTaskWithoutSuccess()
        {
            Console.WriteLine(new string('-', 20));
        ...
        private static void ExecuteTaskFailAndThreadShouldReuse()
        {
            Console.WriteLine(new string('-', 20));
        ...
        private static void ExecuteWhenTaskWouldBeCancelling()
        {
            Console.WriteLine(new string('-', 20));
            ...
            {
                Console.WriteLine("SecondTask after cancelling");
